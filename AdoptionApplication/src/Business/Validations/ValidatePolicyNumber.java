 ...
 * @author HP
 */
public class ValidatePolicyNumber extends InputVerifier{
         ...
         Pattern dobPattern = Pattern.compile(pattern);
            ...
            if (text.length() > 0) {
               if (text.toLowerCase().startsWith(" ") || text.length() == 0 || matcher.matches() != true) {
                ...
                JOptionPane.showMessageDialog(input, "Please Enter Valid PolicyNumber", "Error", JOptionPane.ERROR_MESSAGE);
                return false;
            } else {
